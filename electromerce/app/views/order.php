...
<html lang="en">
  <head>
    ...
    <!-- FontAwesome -->
    <script
      src="https://kit.fontawesome.com/c2f51c50b5.js"
    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
      ...
      >
        <a href="#" class="flex items-center">
          <img
            src="./docs/images/ElectroMerce.svg"
        ...
        <div class="flex items-center justify-between gap-4">
          <div class="z-40 group/item">
            ...
            >
              <i
                class="fa-solid fa-cart-shopping text-blue-800 text-xl pointer-events-auto"
              ></i>
            </button>
            <!-- Dropdown menu -->
            <div
            ...
            >
              <div class="container mx-auto py-8 px-4">
                <div
                  class="flex flex-col items-center h-64 overflow-scroll overflow-x-hidden"
                >
                  <div class="w-full mb-4">
                    <div class="bg-white rounded-lg shadow">
                      <div class="flex items-center mb-4 w-full">
                        <img
                          class="w-16 h-16 rounded-full mr-8"
                          src="/docs/images/products/product-1.jpg"
                          alt="Product Image"
                        />
                        <div class="flex-1">
          ...
          <a
            href="register.html"
            class="text-sm font-medium dark:text-blue-500 hover:underline bg-blue-800 text-white p-1.5 rounded"
            >Sing up</a
          >
        </div>
      </div>
        ...
        <div class="flex items-center">
          <ul class="flex flex-row mt-0 mr-6 space-x-8 text-sm font-medium">
            <li>
              <a
                href="index.html"
                class="text-gray-900 dark:text-white hover:underline hover:text-blue-800"
                aria-current="page"
                >Home</a
              >
            </li>
        ...
        <div class="w-full max-w-md mb-4">
          <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="flex justify-between">
              <button
                class="px-4 py-2 font-bold text-white bg-red-500 rounded-full hover:bg-blue-700 focus:outline-none focus:shadow-outline active:bg-blue-800 mr-2 mb-2"
              >
                Delete
              </button>
              <button
                class="px-8 py-2 font-bold text-white bg-blue-500 rounded-full hover:bg-blue-700 focus:outline-none focus:shadow-outline active:bg-blue-800"
              >
                BUY
              </button>
            </div>
    ...
    <footer class="bg-white dark:bg-gray-900">
      ...
      >
        <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center"
          >© 2022 <a href="https://flowbite.com/">ElectroMerce™™</a>. All Rights
          Reserved.
        </span>
