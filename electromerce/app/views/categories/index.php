...
<div class="w-full overflow-x-auto px-8">
  ...
  <table class="table-auto w-full">
    ...
    <tbody>
      ...
      <tr>
        <!-- <td class="border px-4 py-2"><?php //echo $category->id 
                                            ?></td> -->
        <td class="border px-4 py-2"><?php echo $category->name ?></td>
        <td class="border px-4 py-2 truncate hover:whitespace-normal hover:bg-gray-100 hover:text-gray-800"><?php echo $category->description ?>
        </td>
